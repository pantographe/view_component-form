...
| `lookup_chain` (array of Lambdas) | Logic to lookup the class of a component given name and namespaces. | Finds component with `Component` suffix in namespace defined in the builder  |
